...
def main():
    ...
    parser.add_argument("--train_file", default="./data/newtrain.pkl", type=str)
    parser.add_argument("--eval_file", default="./data/dev.pkl", type=str)
    parser.add_argument("--test_file", default=None, type=str)

    parser.add_argument("--model_type", default="xlnet-large-cased", type=str)
    parser.add_argument("--model_name_or_path", default="../language_model/xlnet-large-cased/", type=str)
    parser.add_argument("--do_lower_case", default=False, type=boolean_string)
    parser.add_argument("--output_dir", default="./state_models/xlnet-large-cased/", type=str)
    ...
    parser.add_argument("--save_check_point", default=6800, type=int)
    ...
    if args.do_train:
        ...
        model = XLNetForSequenceClassification_MERGE.from_pretrained(
