...
def main():
    ...
    parser.add_argument("--model_type", default="albert-base-v2", type=str)
    parser.add_argument("--model_name_or_path", default="../language_model/albert-base-v2/", type=str)
    parser.add_argument("--do_lower_case", default=True, type=boolean_string)
    parser.add_argument("--output_dir", default="./state_models/albert-base-v2/", type=str)
    ...
    parser.add_argument("--save_check_point", default=4400, type=int)
