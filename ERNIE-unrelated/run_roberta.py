...
def main():
    ...
    parser.add_argument("--model_name_or_path", default="../language_model/roberta-large/", type=str)
    parser.add_argument("--do_lower_case", default=True, type=boolean_string)
    parser.add_argument("--output_dir", default="./state_models/roberta-large/", type=str)
